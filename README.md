# Employee Management Database
  ...
  ## Description
  A NODE.JS based application that allows a company to manage a database of employees, from  salary to department orginization.
  ...
  ## Usage
  Use command line and run NODE SERVER.JS
